...
namespace Enterprise.BackServer.Utility
{
    public class JsonConverter
    {
        ...
        /// <returns></returns>
        public static dynamic JsonClass(object obj,bool ignoreNull = true)
        {
            return ConvertJson(Serialize(obj, ignoreNull));
        }
        ...
        /// <returns></returns>
        public static string Serialize(object obj, bool ignoreNull = true, bool DateConvert = false)
        {
            if (ignoreNull && DateConvert == false)
            {
            ...
            return JsonConvert.SerializeObject(obj,Formatting.Indented,new JsonSerializerSettings { NullValueHandling  = NullValueHandling.Include});
        }
        /// <summary>
        /// json转换object动态类     
        /// </summary>
